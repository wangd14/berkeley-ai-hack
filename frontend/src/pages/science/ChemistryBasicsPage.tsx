...
function getLessonPlan(language: string) {
  ...
  const chemistryCourse = scienceCourse.subcourses.find((s: any) => s.name === (language === 'Shona' ? 'Chemistry Basics' : 'Chemistry Basics'));
  if (!chemistryCourse || !chemistryCourse.lessonPlan) return [];
  return chemistryCourse.lessonPlan;
}

const ChemistryBasicsPage: React.FC = () => {
