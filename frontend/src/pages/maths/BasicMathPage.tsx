            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="flex flex-col space-y-4">
                <div className="bg-blue-50 rounded-xl p-4 flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-medium text-blue-900 text-lg">Whole Numbers & Place Value</h3>
                    <p className="text-blue-800">
                      Whole numbers are numbers without fractions or decimals. Place value tells the value of each digit.
                    </p>
                  </div>
                </div>
                <div className="bg-purple-50 rounded-xl p-4 flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-medium text-purple-900 text-lg">Basic Operations</h3>
                    <p className="text-purple-800">
                      Addition, subtraction, multiplication, and division are the four basic operations in math.
                    </p>
                  </div>
                </div>
              </div>
