        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600">Master critical reading strategies and text analysis</p>
            </div>
          </div>
          <p className="text-gray-700 leading-relaxed">
            Develop essential reading skills including active reading, text analysis, context clues, 
            and critical thinking. Learn to identify main ideas, draw conclusions, and understand 
            author's purpose and literary devices.
          </p>
        </div>
