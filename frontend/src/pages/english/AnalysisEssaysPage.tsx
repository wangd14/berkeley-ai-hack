...
export function AnalysisEssaysPage() {
  ...
  // Get the Analysis Essays course data
  ...
  const essaysCourse = englishCourse?.subcourses.find((sub: any) => sub.name === (language === 'Shona' ? 'Writing analysis essays' : 'Writing analysis essays'));
  const lessonPlan = essaysCourse?.lessonPlan || [];
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Writing Analysis Essays</h1>
              <p className="text-gray-600">Analyze texts and develop compelling arguments</p>
            </div>
          </div>
          <p className="text-gray-700 leading-relaxed">
            Master the art of analytical writing to interpret texts and develop well-supported arguments. 
            Learn close reading techniques, thesis development, evidence analysis, and essay structure 
            to create insightful and persuasive analysis essays.
          </p>
        </div>
