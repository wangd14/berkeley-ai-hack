      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Writing Personal Narratives</h1>
              <p className="text-gray-600">Craft compelling stories from your own experiences</p>
            </div>
          </div>
          <p className="text-gray-700 leading-relaxed">
            Learn to write engaging personal narratives that connect with readers. Master story structure, 
            descriptive language, dialogue, and reflection techniques to create meaningful stories 
            that share your experiences and insights.
          </p>
        </div>
